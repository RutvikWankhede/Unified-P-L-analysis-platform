...
from schemas.anomaly_schemas import DetectionResult, AnomalyResponse, AnomalyDetail, AnomalyUpdateStatus
from services.anomaly_service import run_anomaly_detection
from repositories.anomaly_repository import get_anomalies, get_anomaly, update_anomaly_status
...
def update_status(id: int, status_update: AnomalyUpdateStatus, db: Session = Depends(get_db)):
